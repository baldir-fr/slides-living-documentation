...
include::sections/z_who_am_I.adoc[]
...
// Conversations
include::sections/ex_coffee_machine_conversations.adoc[]
include::sections/ex_code_review.adoc[]
include::sections/ex_pair_programming.adoc[]
include::sections/ex_mob_programming.adoc[]
include::sections/ex_3_amigos.adoc[]
...
=== Repeating names of language constructs
...
* Does documentation explain?s _WHY_ or just _HOW_?
