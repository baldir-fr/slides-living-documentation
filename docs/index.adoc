...
// include::sections/ex_getter_javadoc.adoc[]

// include::thanks-agile-tour-strasbourg.adoc[]
include::thanks-software-crafters-lyon.adoc[]
...
include::sections/what_is_documentation.adoc[]
...
include::ok_thanks_slides_infos_lyon.adoc[]